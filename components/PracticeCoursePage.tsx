...
const modeOptions: Array<{
  ...
  { id: "continue", title: "ادامه", subtitle: "از جایی که متوقف شدی", icon: "▷" },
  { id: "unattempted", title: "حل‌نشده", subtitle: "هنوز امتحان نشده", icon: "♡" },
  { id: "mistakes", title: "مرور اشتباهات", subtitle: "کیس‌هایی که اشتباه کردی", icon: "×" },
  { id: "start-over", title: "شروع مجدد", subtitle: "شروع از ابتدا", icon: "↻" },
];
        ...
        <>
            <section className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-[0_10px_35px_rgba(15,23,42,0.04)] sm:p-6">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h2 className="text-[27px] font-semibold tracking-[-0.035em]">فیلتر تمرین</h2>
                  <p className="mt-1 text-sm text-slate-500">انتخاب کیس را شخصی‌سازی کن.</p>
                </div>
              ...
              <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200">
                ...
                >
                  <span className="text-lg text-slate-500">▥</span>
                  <span className="text-sm font-semibold">سطح دشواری</span>
                ...
                >
                  <span className="text-lg text-slate-500">◇</span>
                  <span className="text-sm font-semibold">برچسب‌ها</span>
                  {selectedTags.length > 0 && (
                    <span className="rounded-full bg-blue-50 px-2 py-1 text-[11px] font-semibold text-blue-700">{selectedTags.length} انتخاب</span>
                  )}
              ...
              <div className="mt-5 rounded-2xl bg-slate-50 px-4 py-3 text-xs leading-5 text-slate-500">
                {mode === "continue" && "حالت «ادامه» کیس‌هایی را نشان می‌دهد که شروع شده‌اند اما کامل نشده‌اند."}
                {mode === "unattempted" && "حالت «حل‌نشده» کیس‌هایی را نشان می‌دهد که سابقه تمرین ذخیره‌شده ندارند."}
                {mode === "mistakes" && "«مرور اشتباهات» کیس‌هایی را نشان می‌دهد که تشخیص آن‌ها پس از تلاش‌های مجاز اشتباه شده است."}
                {mode === "start-over" && "«شروع مجدد» پیش از انتخاب کیس، پیشرفت ذخیره‌شده این درس را پاک می‌کند."}
              </div>
            </section>
            ...
            >
              <span>انتخاب کیس ({filteredCases.length})</span>
              <span className="text-xl">→</span>
            </button>
          </>
