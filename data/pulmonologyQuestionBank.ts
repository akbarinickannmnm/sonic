...
export const pulmonologyQuestionCategories: {
  ...
  { id: "onset_and_course", label: "شروع و روند علائم" },
  { id: "dyspnea", label: "تنگی نفس" },
  { id: "cough", label: "سرفه و خلط" },
  { id: "wheeze", label: "خس‌خس" },
  { id: "hemoptysis", label: "هموپتیزی" },
  { id: "chest_pain", label: "درد قفسه سینه" },
  { id: "systemic", label: "علائم سیستمیک" },
  { id: "past_respiratory", label: "سابقه تنفسی" },
  { id: "comorbidities", label: "بیماری‌های همراه و عوامل خطر" },
  { id: "medications", label: "داروها و آلرژی" },
  { id: "smoking_and_vaping", label: "سیگار و ویپ" },
  { id: "occupational", label: "مواجهه شغلی" },
  { id: "home_and_environment", label: "محیط خانه و محیطی" },
  { id: "infectious_exposure", label: "مواجهه عفونی" },
  { id: "aspiration", label: "آسپیراسیون" },
