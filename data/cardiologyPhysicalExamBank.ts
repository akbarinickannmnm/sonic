...
export const cardiologyPhysicalExamCategories = [
  { id: "general", label: "معاینه عمومی" },
  { id: "vitals", label: "علائم حیاتی" },
  { id: "peripheral", label: "معاینه اندام‌ها" },
  { id: "neck", label: "گردن و JVP" },
  { id: "precordial", label: "معاینه پره‌کوردیال" },
  { id: "auscultation", label: "سمع قلب" },
  { id: "respiratory", label: "معاینه تنفسی" },
  { id: "abdominal", label: "معاینه شکم" },
  { id: "special", label: "یافته‌های اختصاصی" },
] as const;
