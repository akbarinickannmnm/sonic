    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold">
                {course === "cardiology" ? "قلب و عروق" : "ریه"} Investigation Bank
              </h1>
        ...
        <div className="mb-6 flex flex-col gap-4 md:flex-row">
          <input
            type="text"
            placeholder="جستجوی بررسی‌های تشخیصی..."
            value={search}
            onChange={(e) =>
              ...
              >
                ...
                {"answer" in investigation && (
                  <div className="mt-4 rounded-lg border border-slate-700 bg-slate-950/60 p-4">
                    <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">پاسخ کلیدی / یافته مورد انتظار</p>
