...
const sections: { id: Section; label: string }[] = [
  ...
  { id: "physicalExam", label: "معاینه فیزیکی" },
  { id: "investigations", label: "بررسی‌های تشخیصی" },
];
    ...
    <main className="min-h-screen bg-slate-100">
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        <div className="mb-6">
          ...
          <h1 className="mt-1 text-3xl font-bold text-slate-900">بانک سوالات دروس</h1>
        ...
        <div className="mb-5 grid gap-4 md:grid-cols-2">
          <input type="text" placeholder="جستجو..." value={search} onChange={(e) => setSearch(e.target.value)} className="rounded-xl border border-slate-300 bg-white px-4 py-3 outline-none focus:border-slate-500" />
        ...
        <div className="mb-4 rounded-2xl bg-white p-4 shadow-sm"><p className="text-sm text-slate-600">نمایش {filteredItems.length} آیتم.</p></div>
            ...
            return (
              <div key={item.id} className="rounded-2xl bg-white p-4 shadow-sm">
                <div className="mb-2 flex flex-wrap items-center gap-2">
                  ...
                  <span className="rounded-lg bg-emerald-50 px-2 py-1 text-xs font-medium text-emerald-700">{answerCount} پاسخ کیس{answerCount === 1 ? "" : "‌ها"}</span>
                </div>
