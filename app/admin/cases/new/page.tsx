          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="مثلاً درد حاد قفسه سینه"
                              ...
                              <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="md:col-span-2">
                                  ...
                                  <textarea
                                    ...
                                    rows={4}
                                    placeholder="نتیجه کاملی را که فراگیر باید دریافت کند وارد کنید..."
                                    className="mt-2 w-full resize-none rounded-xl border border-slate-300 p-3"
                                  />
                                </div>
          ...
          <div className="mt-8">
            ...
            <div className="relative mt-4">
              ...
              <input
                ...
                placeholder="جستجو و افزودن تشخیص افتراقی..."
                ...
                >
                  ...
                  <div className="mt-4">
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder="سوال مرور را بنویسید..."
                  ...
                  <div className="mt-4">
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder="توضیح دهید چرا پاسخ صحیح است..."
                      className="mt-2 w-full resize-none rounded-xl border bg-white p-3"
                    />
